...
echo ""
echo "Step 3: Creating Stage Form Encounter Types"
echo "============================================="
echo "Note: One form per workflow stage."
echo "Forms need to be created manually in Form Builder."
echo ""

# Registration Form
echo "Creating 'Augen Auf Registration Form' encounter type..."
api_call POST "encountertype" '{"name":"Augen Auf Registration Form","description":"Registration stage form encounter type","uuid":"aa003300-1234-5678-90ab-000000000001"}' > /dev/null
echo "✓ Registration Form: aa003300-1234-5678-90ab-000000000001"

# Refraction Form
echo "Creating 'Augen Auf Refraction Form' encounter type..."
api_call POST "encountertype" '{"name":"Augen Auf Refraction Form","description":"Refraction stage form encounter type","uuid":"aa003300-1234-5678-90ab-000000000002"}' > /dev/null
echo "✓ Refraction Form: aa003300-1234-5678-90ab-000000000002"

# Eye Exam Form
echo "Creating 'Augen Auf Eye Exam Form' encounter type..."
api_call POST "encountertype" '{"name":"Augen Auf Eye Exam Form","description":"Eye exam stage form encounter type","uuid":"aa003300-1234-5678-90ab-000000000003"}' > /dev/null
echo "✓ Eye Exam Form: aa003300-1234-5678-90ab-000000000003"

# Therapy Form
echo "Creating 'Augen Auf Therapy Form' encounter type..."
api_call POST "encountertype" '{"name":"Augen Auf Therapy Form","description":"Therapy stage form encounter type","uuid":"aa003300-1234-5678-90ab-000000000004"}' > /dev/null
echo "✓ Therapy Form: aa003300-1234-5678-90ab-000000000004"

# Finished Form
echo "Creating 'Augen Auf Finished Form' encounter type..."
api_call POST "encountertype" '{"name":"Augen Auf Finished Form","description":"Finished stage form encounter type","uuid":"aa003300-1234-5678-90ab-000000000005"}' > /dev/null
echo "✓ Finished Form: aa003300-1234-5678-90ab-000000000005"
...
echo "Created 5 stage form encounter types (one per workflow stage)"
echo "Created 5 queues (one per workflow stage)"
echo ""
echo "Data Model:"
echo "-----------"
echo "- Workflow stages are managed via QUEUES"
echo "- Each patient visit has ONE encounter (aa001100-...0001)"
echo "- Each stage has ONE form with its own encounter type"
echo "- Forms can be filled out at each stage"
